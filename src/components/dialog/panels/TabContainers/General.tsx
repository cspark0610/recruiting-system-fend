			...
			<section className="grid justify-items-center grid-cols-2 gap-[10px] w-[85%]">
				...
				<div className="my-[48px] font-raleway text-gray-color text-[12px] w-full">
					...
					<div className="my-[12px]">
						<h2 className="font-semibold text-[20px] text-cyan-color">{details.name}</h2>
						<p>{details.academic_training ? details.academic_training : 'N/A'}</p>
				...
				<div
					className={`w-full my-[48px] font-raleway text-[12px] ${
						details.main_status === 'interested' ? 'text-[#B3B9C0]' : 'text-gray-color'
					}`}
				>
					<div className="my-[12px]">
					...
					<div className="my-5 flex flex-row">
						<p>
							Salary Expectations:{' '}
							<span className="font-bold">{salary_expectations ?? 'N/A'}</span>{' '}
						</p>
						<p className="ml-[45px]">
							Available from:{' '}
