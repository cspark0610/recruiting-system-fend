	...
	return (
		<div className="grid justify-items-center">
			<div className="mt-[48px] grid justify-items-start w-[85%]">
				<p className="font-raleway font-semibold text-gray-color text-[20px]">{name}</p>
			</div>
			<section className="grid justify-items-center grid-cols-2 gap-[10px] w-[85%]">
				<div className="w-full">
					<div className="my-[32px]">
						<p className="font-raleway text-gray-color text-[15px] font-bold uppercase my-3">Yes</p>
						<div className="relative bg-light-color border-light-color rounded-[5px] w-[435px] h-[372px]">
							<div className="absolute top-5 right-[21px] z-10 h-[18rem] space-y-2 overflow-y-auto">
								{conclusions.good.length === 0
									? ""
									: conclusions.good.map((value: IConclusionInv, index: number) => (
											<div key={index}>
												...
												<div
													ref={
														conclusions.good.indexOf(value) === conclusions.good.length - 1
															? lastGoodConclusion
															: null
													}
												></div>
				...
				<div className="w-full">
					<div className="my-[32px]">
						<p className="font-raleway text-gray-color text-[15px] font-bold uppercase my-3">No</p>
						<div className="relative bg-light-color border-light-color rounded-[5px] w-[435px] h-[372px]">
							<div className="absolute top-5 right-[21px] z-10 h-[18rem] space-y-2 overflow-y-auto">
								{conclusions.bad.length === 0
									? ""
									: conclusions.bad.map((value: IConclusionInv, index: number) => (
											<div key={index}>
												<div className="flex h-[0.7rem] items-center justify-between">
													<div className="w-36 h-[0.1rem] bg-gray-300"></div>
													<div className="text-sm text-gray-400 font-raleway capitalize">
												...
												<div
													ref={
														conclusions.bad.indexOf(value) === conclusions.bad.length - 1
															? lastBadConclusion
															: null
													}
												></div>
