	...
	return (
		<div className="w-full p-3">
			<ReactPhoneInput
				...
				} w-full bg-light-color focus:outline-none focus:bg-white font-light font-raleway text-gray-color focus:border-cyan-color border focus:shadow-cyan-color/50 focus:shadow-md placeholder:text-gray-color font-sans `}
				containerClass={`${
					value && '!border-cyan-color bg-light-blue'
