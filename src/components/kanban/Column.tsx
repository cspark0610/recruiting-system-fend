					...
					{isLoading ? (
						...
						<>
							{items.length === 0 && !error.message ? (
								<p className="text-center mt-40 text-lg font-bold font-raleway">No candidates...</p>
							) : error.message !== "" ? (
								<p className="text-center mt-40 text-lg font-bold font-raleway">{error.message}</p>
							) : (
