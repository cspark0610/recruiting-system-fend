...
const Thanks = lazy(() => import('@/views/first_link/Thanks'))
const Welcome = lazy(() => import('@/views/second_link/Welcome'))
const Instructions = lazy(() => import('@/views/second_link/Instructions'))
const Required = lazy(() => import('@/views/second_link/Required'))
const NotFound = lazy(() => import('@/views/error/NotFound'))
const Details = lazy(() => import('@/views/second_link/Details'))
const VideoStart = lazy(() => import('@/views/second_link/VideoStart'))
const VideoCompleted = lazy(() => import('@/views/second_link/VideoCompleted'))
