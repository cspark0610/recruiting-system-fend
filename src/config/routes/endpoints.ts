...
export const GET_ALL_CANDIDATES_FILTERED =
	'/candidate/filter'
export const GET_ALL_CANDIDATES_FILTERED_EXPERT =
	'/candidate/expert/filter'
export const UPDATE_CANDIDATE_EMPLOYMENT_STATUS =
	'/candidate/employment_status/update'
export const ADD_POSTULATION_TO_CANDIDATE =
	'/candidate/add_postulation'
...
export const UPDATE_POSTULATION_INFO =
	'/postulation/info/update'
...
export const UPDATE_CONCLUSION =
	'/candidate/conclusions/set'
