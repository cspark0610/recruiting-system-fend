...
export const sortByColumn = (candidates: ICandidate[]) => {
	...
	candidates.forEach(candidate => {
		...
		filteredByInterested.length &&
			interested.push({
				...candidate,
				postulations: filteredByInterested,
			})
		filteredByApplying.length &&
			applying.push({
				...candidate,
				postulations: filteredByApplying,
			})
		filteredByMeeting.length &&
			meeting.push({
				...candidate,
				postulations: filteredByMeeting,
			})
		filteredByChosen.length &&
			chosen.push({
				...candidate,
				postulations: filteredByChosen,
			})
		filteredByHired.length &&
			hired.push({
				...candidate,
				postulations: filteredByHired,
			})
	})
...
export const MAIN_STATUS_ALLOWED = [
	'interested',
	'applying',
	'meeting',
	'chosen',
